layui.use(['jquery', 'common', 'layer', 'element'], function() {
	...
	common.larryCmsLoadJq('/Areas/Backstage/Content/common/plus/jquery.leoweather.min.js', function () {
		$('#weather').leoweather({
	...
	common.larryCmsLoadJq('/Areas/Backstage/Content/common/plus/echarts.min.js', function () {
